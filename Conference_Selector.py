...
def run_app():
    ...
    st.markdown("<span style='font-size: 0.9em;'>The current temperature is mathematically mapped to one of the potential cities, ensuring an even and consistent distribution.</span>", unsafe_allow_html=True)
